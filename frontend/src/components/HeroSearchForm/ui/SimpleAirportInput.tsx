...
export const SimpleAirportInput: FC<Props> = ({ inputName, label, placeholder = '', defaultValue = '' }) => {
  ...
  return (
    <div className="relative" ref={containerRef}>
      {/* Pin-iconed pill: pin on the left, floating label + input stacked on
          the right. When empty we hide the label and use it as a placeholder
          inside the input (matches the Booking-style "Leaving from" pattern
          in the design spec). */}
      <div className="relative flex items-center gap-3 rounded-lg border border-neutral-300 bg-white px-4 py-2 focus-within:border-orange-500 focus-within:ring-1 focus-within:ring-orange-500 dark:border-neutral-600 dark:bg-neutral-800">
        ...
        <div className="min-w-0 flex-1">
          <label className="block text-[11px] font-medium leading-tight text-neutral-700 dark:text-neutral-300">
            {label}
          </label>
          <input
            ref={inputRef}
